...
Every AC-D1–AC-D31 and every AC-CD1–AC-CD26 is referenced by at least one
phase or workstream above and one CHECKLIST row (AC-D28 + AC-CD25 minted in
v1.9, AC-D29 minted in v1.9 (PR-B), AC-D30 + AC-D31 minted in v1.9 (PR-C), AC-CD26 minted in v1.9 (PR-D — with the GapSignal §5 entity), are owned by the autonomous-content-generation workstream). AC-CD11's pre-build gate at P6 was
