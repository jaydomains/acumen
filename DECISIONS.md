...
*End of Acumen decisions anchor log. 28 decisions locked (AC-D1–AC-D28); 6 v1.1 + 3 v1.2 + 1 v1.3 + 1 v1.4 + 1 v1.5 + 6 v1.6 + 1 v1.7 + 1 v1.8 + (1 mint AC-D28 + 3 amendments AC-D21/AC-D22/AC-D23 in v1.9, autonomous-content cycle PR-A) plus new AC-D27. Status: v1.9. Paired with `SPEC.md` v1.9.*
