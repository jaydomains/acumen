...
|---|---|---|---|---|---|
| Source-authority allowlist + scoring registry | A1 | AC-D28 | `app/domain/source_authority.py` (NEW), `app/config.py`, `.env.example` | missing | not built — gated on PR-A merge + A1 execution (detail-plan PR #108 §1.5 names the five zero-network tests). |
