...
`SPEC.md` v1.10, `DECISIONS.md` v1.10. (P5 "5 Anthropic ops" / P7 build-state rows reflect what those phases built — the canonical operation count is nine per AC-D1/AC-CD8 v1.10; the new ops are tracked unbuilt in the autonomous-content workstream row above.)*
