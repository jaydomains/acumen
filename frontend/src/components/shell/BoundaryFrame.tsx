...
export function BoundaryFrame({
  ...
  return (
    ...
    >
      ...
      <h1 className="font-serif text-[26px] leading-[1.18] tracking-[-0.018em] sm:text-[30px] lg:text-[36px] mb-3 break-words">
        {title}
      </h1>
      <div className="text-ink-2 text-[14px] leading-[1.6] max-w-[44ch] break-words">
        {body}
      </div>
