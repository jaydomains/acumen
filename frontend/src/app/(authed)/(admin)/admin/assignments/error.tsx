...
/** Pattern C boundary for the assignments list. */
...
export default function AssignmentsError({
  ...
  return (
    <BoundaryFrame
      ...
      title={
        <>
          Couldn&rsquo;t load <span className="serif-it">assignments</span>
        </>
      }
      body="The assignments request failed. Try again, and if it keeps failing, let your administrator know."
      actions={
        <>
