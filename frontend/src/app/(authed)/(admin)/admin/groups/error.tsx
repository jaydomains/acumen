...
/** Pattern C boundary for the groups list. */
...
export default function GroupsError({
  ...
  return (
    <BoundaryFrame
      ...
      title={
        <>
          Couldn&rsquo;t load <span className="serif-it">groups</span>
        </>
      }
      body="The groups request failed. Try again, and if it keeps failing, let your administrator know."
      actions={
        <>
