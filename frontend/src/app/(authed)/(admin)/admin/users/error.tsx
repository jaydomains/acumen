...
/** Pattern C boundary for the users list page. */
...
export default function UsersError({
  ...
  return (
    <BoundaryFrame
      ...
      title={
        <>
          Couldn&rsquo;t load <span className="serif-it">users</span>
        </>
      }
      body="The users request failed. Try again, and if it keeps failing, let your administrator know."
      actions={
        <>
