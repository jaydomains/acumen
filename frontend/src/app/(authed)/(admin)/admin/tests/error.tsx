...
/** Pattern C boundary for the tests list. */
...
export default function TestsError({
  ...
  return (
    <BoundaryFrame
      ...
      title={
        <>
          Couldn&rsquo;t load <span className="serif-it">tests</span>
        </>
      }
      body="The tests request failed. Try again, and if it keeps failing, let your administrator know."
      actions={
        <>
