...
/** Pattern C boundary for the system-operations page (FE-9 §C.5). */
...
export default function SystemError({
  ...
  return (
    <BoundaryFrame
      ...
      title={
        <>
          Couldn&rsquo;t load <span className="serif-it">system operations</span>
        </>
      }
      body="The system-operations page failed to load. Try again, and if it keeps failing, let your administrator know."
      actions={
        <>
