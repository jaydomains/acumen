...
/** Pattern C boundary for the grade-review queue page (FE-9 §C.5). */
...
export default function GradeReviewError({
  error,
  reset,
}: {
  ...
  return (
    <BoundaryFrame
      ...
      title={
        <>
          Couldn&rsquo;t load the <span className="serif-it">review queue</span>
        </>
      }
