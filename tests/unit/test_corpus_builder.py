...
async def test_safety_corroboration_cross_source(
    ...
    """For a safety-relevant topic, identical chunk text from two distinct
    allowlisted sources stamps corroboration_count=2 (DS2-b option ii);
    a non-safety topic leaves it at 1."""
